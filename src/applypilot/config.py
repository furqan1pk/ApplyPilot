...
# Persistent screenshots per job (keyed by URL hash)
...
def ensure_dirs():
    ...
    for d in [APP_DIR, TAILORED_DIR, COVER_LETTER_DIR, LOG_DIR, CHROME_WORKER_DIR, APPLY_WORKER_DIR, SCREENSHOT_DIR]:
